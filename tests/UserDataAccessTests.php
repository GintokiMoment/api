...
function testConvertModelToRow(){
	...
	$expectedResult = array(
		...
		'user_role' => "1",
		'user_password' => $da->saltAndHashPassword("xxx", "opensesame"), // Hash the password
		'user_salt' => $options['salt'],
		'user_active' => true
	);
...
function testGetAll(){
	...
	$expectedResult = [
		new User(['id' => 1, 'firstName' => "John", 'lastName' => "Doe",'email' => "john@doe.com",	'roleId' => "1",'password' => "",	'salt' => "",'active' => true]),
		new User(['id' => 2, 'firstName' => "Jane", 'lastName' => "Anderson",'email' => "jane@doe.com",	'roleId' => "2",'password' => "",'salt' => "",'active' => true]),
		new User(['id' => 3, 'firstName' => "Bob", 'lastName' => "Smith",'email' => "bob@smith.com", 'roleId' => "2",'password' => "", 'salt' => "",'active' => false])
	];
...
function testGetById(){
	...
	$expectedResult = new User(['id' => 1, 'firstName' => "John", 'lastName' => "Doe",'email' => "john@doe.com",	'roleId' => "1",'password' => "",	'salt' => "",'active' => true]);
...
function testInsert(){
	...
	$expectedResult = new User(['id' => 4, 'firstName' => "Chris", 'lastName' => "Jones",'email' => "chris@jones.com",	'roleId' => "1",'password' => "",	'salt' => "",'active' => true]);
